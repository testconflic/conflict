...
namespace Northwind.MySQL.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<List<Product>> GetSupplierFromProductName(string productName)
        {
        ...
        public async Task<IEnumerable<AlphabeticalListOfProduct>> GetOrderdetailFromProductName()
        {
